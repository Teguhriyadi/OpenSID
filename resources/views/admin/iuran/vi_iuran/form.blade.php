    ...
    <div class="col-md-8">
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <form action="<?= site_url('vi_iuran/insert') ?>" method="POST">
                    <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="agenid" class="form-control" id="agenid">
                                        ...
                                        <option value="1">Mohammad Ilham Teguhriyadi</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="nik" class="form-control" id="nik">
                                        <option value="">- Pilih -</option>
                                        <option value="1">239029302293023</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="produk" id="produk" placeholder="Masukkan Produk">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="tagihan" id="tagihan" placeholder="0">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="execs" id="execs" placeholder="Masukkan Execs">
                                </div>
                            </div>
                        </div>
                    </div>
