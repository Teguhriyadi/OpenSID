...
<body id="kt_body" class="app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    <div class="w-lg-475px p-10">
                        <form class="form w-100" action="<?= site_url('siteman/auth') ?>" method="POST">
                            <div class="text-start mb-11">
                                <a href="./login.html">
                                    <img alt="Logo" src="<?= base_url() ?>themes/media/logos/logo.png" class="h-60px ms-n11 mb-7" />
                                </a>
                            ...
                            <div class="row g-3 mb-9">
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                        <img alt="Logo" src="https://digidesa.alphatechin.id/assets/media/svg/brand-logos/google-icon.svg" class="h-15px me-3" />
                                        Login dengan Google
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                        <img alt="Logo" src="https://digidesa.alphatechin.id/assets/media/svg/brand-logos/apple-black.svg" class="h-15px me-3" />
                                        Login dengan Apple
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="fv-row w-100 fv-plugins-icon-container mb-5">
                                ...
                                <input type="text" name="username" class="form-control mb-2" placeholder="contoh">
                            ...
                            <div class="fv-row w-100 fv-plugins-icon-container mb-5" data-kt-password-meter="true">
                                ...
                                <div class="position-relative">
                                    <input type="password" name="password" class="form-control mb-2 pe-14" placeholder="********">
            ...
            <div class="bg-auth d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2 ">
    ...
    <script src="<?= base_url() ?>themes/plugins/global/plugins.bundle.js"></script>
    <script src="<?= base_url() ?>themes/js/scripts.bundle.js"></script>
    <script src="<?= base_url() ?>themes/plugins/external/ripple/js/ripple.min.js"></script>
</body>
